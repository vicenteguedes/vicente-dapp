...
export interface ChainData {
  ...
  name: string;
  contracts: Record<string, { address: Address; decimals: number }>;
  chain: Chain;
}
...
export const SEPOLIA_DATA: ChainData = {
  ...
  contracts: {
    ...
    WBTC: {
      address: "0xFa1e53C68c045589cb5BaC4B311337c9f42e2241",
      decimals: 8,
    },
    BUSD_WBTC: {
      address: "0x277B37e50272f74f7Bc00a857C99dAe937378E3f",
      decimals: 18,
    },
    UNISWAP_ROUTER: {
      address: "0x13603a16785B335dC63Edb4d4b1EA5A24E10ECc9",
      decimals: 10,
    },
  },
  chain: sepolia,
